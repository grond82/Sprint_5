...
class TestLocators:
    ...
    CONSTRUCTOR_FILLINGS_SELECT = (By.XPATH, ".//div[contains(@Class, 'tab_tab_type_current')]") #Локатор, если Начинки выбраны
    CONSTRUCTOR_SAUCES = (By.XPATH, ".//span[contains(text(),'Соусы')]") #Локатор для клика на Соусы
    CONSTRUCTOR_SAUCES_SELECT = (By.XPATH, ".//div[contains(@Class, 'tab_tab_type_current')]") #Локатор, если Соусы выбраны
    CONSTRUCTOR_BUNS = (By.XPATH, ".//span[contains(text(),'Булки')]") #Локатор для Булок
    CONSTRUCTOR_BUNS_SELECT = (By.XPATH,".//div[contains(@Class, 'tab_tab_type_current')]") #Локатор, если Булки выбраны
    ...
    FIELD_NAME_ON_REGISTRATION_PAGE = (By.XPATH, "//label[text()='Имя']/following-sibling::input") #Локатор для поля Имя на странице Регистрации
    FIELD_EMAIL_ON_REGISTRATION_PAGE = (By.XPATH, "//label[text()='Email']/following-sibling::input") #Локатор для поля Email на странице Регистрации
